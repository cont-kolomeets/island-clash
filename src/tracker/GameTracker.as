...
package tracker
{
	...
	public class GameTracker extends EventDispatcher
	{
        ...
        */
		...
		public function writeCurrentGameStatus(gameInfo:GameInfo):void
		{
			customMsg(gameInfo.generateStatusForGame());
			customMsg(gameInfo.generateStatusForLevels());
			customMsg(gameInfo.generateStatusForDevelopment());
		}
