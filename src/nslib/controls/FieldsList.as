...
package nslib.controls
{
	...
	import nslib.controls.events.ListEvent;
	import nslib.controls.events.SizeEvent;
	 ...
	 */
	public class FieldsList extends NSSprite
	{
		...
		private var ghostLabel:NSSprite = new NSSprite();
		...
		private function setCollapseButtonAppearance(button:ToggleButton):void
		{
			...
			var upImage:NSSprite = new NSSprite();
			...
			var downImage:NSSprite = new NSSprite();
